...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark  fixed-top">
        <a class="navbar-brand" style="font-family:italic;margin-left: 50px;" href="index.php"><h3>Online Cloth Store</h3></a>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel" >
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="downloads/cloth.jpg" >
                <div class="carousel-caption text-center">
                    <h1>WELCOME TO OUR STORE</h1>
                    <h3> A VERSATILE CLOTH CORNER</h3>
                    <a class="btn btn-outine-light btn-lg" href="#items" style="color:white;border-color: white;">Get Started</a>
                </div>
            </div>
            <div class="carousel-item">
                <img src="downloads/alexandre-godreau-7YlHU_ZPS34-unsplash.jpg" alt="Chicago">
            </div>
            <div class="carousel-item">
                <img src="downloads/cloth1.jpg" alt="New York">
            </div>
        </div>
...
-->
               ...
               <li class="list-group-item bg-dark" style="color:white">
                   <div class="form-check">
                       <label class="form-check-label">
                           <input type="checkbox" class="form-check-input product_check" value="<?= $row['Type'];?>" id="Type">
          <?= $row['Type'];?>             </label>
                   </div>
               </li>
              <?php }?> 
    ...
    <div id="items" class="offset">
        ...
        while($row=$result->fetch_assoc()):
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 " style="margin-top:50px">
                    <div class="card text-center border-success" >
                        <img class="card-img-top bg-light img-fluid" src="<?= $row['product_image']?>" style="height:400px" >
...
--> 
 <p style="margin-left: 40%">&copy; OCT</p></div>
<!--                <hr class="socket">-->
    ...
    $(".product_check").click(function(){
           var action = 'data';
            ...
            $.ajax({
               url:'action.php',
                method:'POST',
                data:{actionf:action,brand:brand,product_price:product_price,Type:Type},
                success:function(response){
