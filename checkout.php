...
<li class="nav-item dropdown">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-6 px-4 pb-4" id="order" style="margin-bottom:250px">
                ...
                <form action="" method="post" id="placeOrder">
                    ...
                    <div class="form-group">
                       <textarea name="address" class="form-control" rows="3" cols="6" placeholder="Enter Address" required></textarea>
                    </div>
